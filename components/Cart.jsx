...
const Cart = () => {
  ...
  const { totalPrice, totalQuantities, cartItems, setShowCart, toggleCartItemQuantity, onRemoveFromCart } =
    useStateContext();
              ...
              <div className='product' key={item._id}>
                ...
                <div className='item-desc'>
                  ...
                  <div className='flex bottom'>
                    ...
                    <button type='button' className='remove-item' onClick={() => onRemoveFromCart(item)}>
                      <TiDeleteOutline />
                    </button>
                  </div>
                </div>
